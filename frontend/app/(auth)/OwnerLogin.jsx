            ...
            <View style={styles.responsiveWrap}>
              ...
              >
                ...
                <View style={styles.headerTextBlock}>
                  <Text style={[styles.headerLabel, { color: colors.muted }]}>Owner Login</Text>
              ...
              <View style={styles.content}>
                ...
                >
                  <View style={styles.badgeContainer}>
                    <View style={[styles.badge, { backgroundColor: colors.accentBg }]}>
                      <Ionicons name="mic" size={moderateScale(14)} color={colors.accent} />
                ...
                <Animated.View style={[styles.footerInScroll, { opacity: footerFade }]}>
                  ...
                  <TouchableOpacity 
                    onPress={() => router.push('/(auth)/OwnerSignup')}
                    activeOpacity={0.7}
                  >
